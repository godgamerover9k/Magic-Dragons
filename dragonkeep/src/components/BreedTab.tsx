...
import { formatDuration, rarityOf } from "@/game/economy";
...
import { Button, Empty, Panel, RarityChip, SectionHeading } from "./ui";
      ...
      {pool && (
        <Panel className="p-3">
          <div className="mb-2 flex items-center justify-between">
            ...
            <Button variant="ghost" onClick={() => setShowOdds(!showOdds)}>
          ...
          {!pool.exclusiveRule && (
            <p className="mt-2 border-t border-line pt-2 text-[11px] text-muted">
              Both parents sit in the pool at weight {pack.balance.parentWeight}. Rules add
      ...
      {dragon ? (
        <>
          ...
          <div className="mt-1.5 flex items-center gap-2">
            <RarityChip rarity={rarityOf(pack, dragon)} />
